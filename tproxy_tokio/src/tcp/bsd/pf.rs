        ...
        unsafe {
            ...
            match *bind_addr {
                SocketAddr::V4(ref v4) => {
                    ...
                    ptr::copy_nonoverlapping(
                        addr,
                        &mut pnl.daddr.pfa.v4,
                        mem::size_of_val(&pnl.daddr.pfa.v4),
                    );
                    pnl.set_dport(port);
                }
                SocketAddr::V6(ref v6) => {
                    ...
                    ptr::copy_nonoverlapping(
                        addr,
                        &mut pnl.daddr.pfa.v6,
                        mem::size_of_val(&pnl.daddr.pfa.v6),
                    );
                    pnl.set_dport(port);
                }
            }
            ...
            match *peer_addr {
                SocketAddr::V4(ref v4) => {
                    ...
                    ptr::copy_nonoverlapping(
                        addr,
                        &mut pnl.saddr.pfa.v4,
                        mem::size_of_val(&pnl.saddr.pfa.v4),
                    );
                    pnl.set_sport(port);
                }
                SocketAddr::V6(ref v6) => {
                    ...
                    ptr::copy_nonoverlapping(
                        addr,
                        &mut pnl.saddr.pfa.v6,
                        mem::size_of_val(&pnl.saddr.pfa.v6),
                    );
                    pnl.set_sport(port);
                }
            }
